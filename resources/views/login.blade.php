                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="{{ url('/') }}">
                                <img width="128px" height="128px" src="{{ url('/images/logo.png') }}">
                                <h3>NPR MANUFACTURING INDONESIA</h3>
                            </a>
                        </div>
                        <div class="login-form">
                            <form method="post" id="formlogin">
                                ...
                                <button id="btnlogin" class="au-btn au-btn--block au-btn--green m-b-20" type="submit">Sign In</button>
                            </form>

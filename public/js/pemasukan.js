...
$("#btnexcel").click(function(event) {
    ...
    $.get(baseurl+'pemasukan/excel',{jenis_dokumen:$("#filterdokumen").val(),startdate:$("#filterdate").val(),enddate:$("#filterdate1").val()}, function(data) {
...
$.get(baseurl+'pemasukan/jenis_dokumen', function(data) {
	$.each(data.data, function(index, val) {
		$("#filterdokumen").append('<option value="'+val.jenis_dokumen+'">'+val.jenis_dokumen+'</option>');
	});
});

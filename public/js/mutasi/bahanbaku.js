...
$("#btnexcel").click(function(event) {
    ...
    $.get(baseurl+'mutasi/bahanbaku/excel',{startdate:$("#filterdate").val(),enddate:$("#filterdate1").val()}, function(data) {

...
$("#btnexcel").click(function(event) {
    ...
    $.get(baseurl+'mutasi/barangsisa/excel',{startdate:$("#filterdate").val(),enddate:$("#filterdate1").val()}, function(data) {
